<template>
  <PageComponent title="Dashboard" >
    ...
    >
      ...
      <div
        class="row-span-2 bg-white animate-fade-in-down  shadow-md p-4 order-3 lg:order-1"
      >
      ...
      <div
        class="row-span-2 bg-white  animate-fade-in-down shadow-md p-3 order-4 lg:order-3"
